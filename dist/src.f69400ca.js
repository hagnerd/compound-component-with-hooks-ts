...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"components/counter.tsx":[function(require,module,exports) {
"use strict";
...
var CounterContext = React.createContext(null);

function useCreateContext(Context, error) {
...
function Counter(_a) {
  var _b = _a.initialValue,
      initialValue = _b === void 0 ? 0 : _b,
      children = _a.children;

  var _c = React.useState(initialValue),
      count = _c[0],
      setCount = _c[1];
...
function IncrementButton(_a) {
  var children = _a.children;
  var increment = useCounterContext().increment;
  return React.createElement("button", {
    onClick: increment
  }, children);
}

function DecrementButton(_a) {
  var children = _a.children;
  var decrement = useCounterContext().decrement;
  return React.createElement("button", {
    onClick: decrement
  }, children);
}
...
function ResetButton(_a) {
  var children = _a.children;
  var reset = useCounterContext().reset;
  return React.createElement("button", {
    onClick: reset
  }, children);
}
...
function Count() {
  var count = useCounterContext().count;
  return React.createElement("h2", null, count);
}

function Usage() {
  return React.createElement(Counter, null, React.createElement(Count, null), React.createElement(IncrementButton, null, "+1"), React.createElement(DecrementButton, null, "-1"), React.createElement(ResetButton, null, "Reset"));
}
...
function (_super) {
  ...
  ErrorBoundary.prototype.render = function () {
    if (this.state.hasError) {
      return React.createElement(React.Fragment, null, React.createElement("h1", null, "Something went wrong."), React.createElement("h2", null, this.state.error && this.state.error.message));
    }
...
function Failure() {
  return React.createElement(ErrorBoundary, null, React.createElement(Count, null));
}
...
var App = function App() {
  ...
  return React.createElement(React.Fragment, null, toggle ? React.createElement(React.Fragment, null, React.createElement("h1", null, "Usage"), React.createElement(counter_1.Usage, null)) : React.createElement(React.Fragment, null, React.createElement("h1", null, "Failure"), React.createElement(counter_1.Failure, null)), React.createElement("button", {
    onClick: function onClick() {
      return setToggle(function (t) {
        return !t;
      });
    }
  }, "Toggle"));
...
exports.default = App;
},{"react":"../node_modules/react/index.js","./components/counter":"components/counter.tsx"}],"index.tsx":[function(require,module,exports) {
"use strict";
